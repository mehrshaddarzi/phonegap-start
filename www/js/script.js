...
var loading = '<div id="load-index" class="loader loader--style3" title="2"> <svg version="1.1" id="loader-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="60px" height="60px" viewBox="0 0 50 50" style="enable-background:new 0 0 50 50;" xml:space="preserve"> <path fill="#fff" d="M43.935,25.145c0-10.318-8.364-18.683-18.683-18.683c-10.318,0-18.683,8.365-18.683,18.683h4.068c0-8.071,6.543-14.615,14.615-14.615c8.072,0,14.615,6.543,14.615,14.615H43.935z"> <animateTransform attributeType="xml" attributeName="transform" type="rotate" from="0 25 25" to="360 25 25" dur="0.6s" repeatCount="indefinite"/> </path> </svg></div>';
var imie = 'sd';
var mobile_number = '+989358510091';
var app_main = jQuery("div#text-index");


/*Wow Animation*/
new WOW({ mobile: false, offset: 50, live: true }).init();
    ...
    jQuery.ajax({
        ...
        success:function(data) {
            ...
            if(data.show_vote =="yes") {
                html += '<a class="home-btn btn btn-default wow fadeInUp" data-wow-duration="1s" data-wow-delay="0s" href="#" role="button" data-type-vote="' + link + '"><span data-type-vote="yes">' + title + '</span></a>';
            }

            html += '<a class="home-btn btn btn-default wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s" href="#" id="show-list-news" role="button">اخبار و مقالات </a><a class="home-btn btn btn-default wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s" href="#" id="href-exit" role="button"> خروج </a>';

            jQuery("div#text-index").html(html);
        },
        error: function(jqXHR, textStatus, errorThrown){
            // if(jqXHR.status==0) {alert(" fail to connect, please check your connection settings");}
            jQuery("div#text-index").html('<div class="panel text-center" style="padding:25px;"> <i class="fa fa-exclamation-triangle"></i> خطای برقراری ارتباط با اینترنت <br> <div style="font-size:11px; margin-top:5px;"> لطفا اتصال به اینترنت خود را چک کنید و سپس وارد اپلیکیشن شوید</div> </div>');
        }
    });
}
    ...
    jQuery.ajax({
        ...
        success:function(data) {
            ...
            for (var i = 0; i < data['text'].length; i++) {
                ...
                html += '</h1>';
                html += '<span class="text-danger wow fadeInDown"><i class="fa fa-calendar"></i> ';
...
jQuery(document).on("click", "[data-show-one-post]", function (e) {
    ...
    jQuery.ajax({
        ...
        success:function(data) {
			...
			html += data['title'];
			html += '</h1>';
			html += '<span class="text-danger"><i class="fa fa-calendar"></i> ';
			html += data['time'];
			html += '</span>';
